		...
		<>
			<div className="release-notes-page">
				...
				<div className="release-notes-picker">
					<NavLink to="/release-notes/cs-ui-components" className="release-notes-link cs-ui">
						<CSIcon name="layout" color="#000" />
						<span>CS UI Components</span>
					</NavLink>
					<NavLink to="/release-notes/future-scope" className="release-notes-link cs-grid">
						<CSIcon name="table" color="#fff" />
						<span>CS Grid</span>
					</NavLink>
					<NavLink to="/release-notes/future-scope" className="release-notes-link cs-form">
						<CSIcon name="edit_form" color="#000" />
						<span>CS Form</span>
					</NavLink>
					<NavLink to="/release-notes/future-scope" className="release-notes-link future-scope">

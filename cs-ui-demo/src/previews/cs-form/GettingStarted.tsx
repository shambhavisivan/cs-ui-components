	...
	<CSD.Page title="Getting started" routePrefix="cs-form">
		<CSD.Section>
			...
			<CSD.Text>
				...
				Whole library is built with `cs-ui-components` library.
			</CSD.Text>
			<CSD.Text>
			...
			<CSD.Text>
				...
				Standard form fields represent basic form fields used for collecting input or displaying data (input fields, textarea, picklist etc.).
		...
		<CSD.Section>
			...
			<CSD.List>
				<CSD.ListItem>in form definition each form field attribute has to be defined in its corresponding field type object (in old CSForm
					`fetchPossibleValues` and `fetchReferenceOptions` are defined as part of CSForm component props)</CSD.ListItem>
				<CSD.ListItem>use `defineFormData()` method in order to combine actual data and form definition (old CSForm's descriptor)</CSD.ListItem>
				...
				<CSD.ListItem>to validate whole form use `validateForm()` method (this would replace old CSForm's `Save` button)</CSD.ListItem>

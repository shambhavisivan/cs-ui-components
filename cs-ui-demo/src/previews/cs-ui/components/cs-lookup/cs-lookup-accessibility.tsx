...
export default {
	...
	customContent: (
		<CSD.Section>
			<CSD.Text>
				CSLookup is fully accessible, where accessibility conformance is settled with a number of things
			...
			<CSD.Text>
				...
				`aria-required` and `aria-invalid` give semantic information when the lookup is required and invalid respectively.
	...
	requirements: {
		...
		keyboardOperability: [
			...
			'`Enter` on field - toggles dropdown display',
			'`Enter` on option - selects an option',
			'`Esc` - closes dropdown',
			'`ArrowUp` on options - moves up through the options and highlights it',
			'`ArrowDown` on options - moves down through the options and highlights it'
		]
	}
};

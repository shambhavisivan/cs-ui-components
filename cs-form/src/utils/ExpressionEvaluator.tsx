 ...
 */
export function evaluateCustomExpression(formSettings: FormSettings, data: Record<string, any>, expression: string): boolean {
	...
	return !!pluginFn.apply(
		null,
		[formSettings, ...Object.keys(data).map(k => data[k])]
	);
}
